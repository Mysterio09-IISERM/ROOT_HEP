...
void Gendata3_4(){
    ...
    gSystem->RedirectOutput("../logs/Gendata3_4.log", "w");
    ...
    RooRealVar var("var4", "Variable", 80.0, 100.0);
    ...
    RooRealVar mean("mean", "Mean", 91.0, 88.0, 95.0);
    RooRealVar sigma("sigma", "Sigma", 1.0, 0.1, 7.0);
    ...
    cmain1->SaveAs("../Png_files/Gendata3_4_results.png");
    cmain2->SaveAs("../Png_files/Gendata3_4_pull.png");

    ofstream out("../Txt_files/Gendata3_4_results.txt");
