...
void Newdata7(){
    ...
    TH1F *h1 = new TH1F("h1", "Generated Distribution; Var; Counts", 800, 40.0, 110.0);
    t->Draw("reflection_peak >>h1", "", "goff");
    h1->SetDirectory(0);
    f->Close();
    delete f;
    ...
    RooRealVar var("reflection_peak", "Variable", 40.0, 110.0);
    ...
    RooRealVar mean1("mean1", "Mean1", 77.0, 70.0, 86.0);
    RooRealVar sigma1("sigma1", "Sigma1", 2.5, 0.1, 15.0);
    RooRealVar mean2("mean2", "Mean2", 90.0, 80.0, 100.0);
    RooRealVar sigma2("sigma2", "Sigma2", 1.0, 0.1, 5.0);
    RooRealVar frac("frac", "Fraction of Signal 1", 0.5, 0.0, 1.0);


    // BACKGROUND PARAMETERS

    RooRealVar tau("tau", "Tau", -0.2, -5.0, -0.001);
    ...
    cmain->SaveAs("../Png_files/Newdata7.png");

    ofstream out("../Txt_files/Newdata7_results.txt");
