...
void Newdata4(){
    ...
    RooRealVar var("crystal_tail", "Variable", 60.0, 100.0);
    ...
    RooCrystalBall signal("signal", "Signal PDF", var, mean, sigma, alpha, n);
    ...
    cmain->SaveAs("../Png_files/Newdata4.png");

    ofstream out("../Txt_files/Newdata4_results.txt");
