...
void ComplexFitSamples5(){

    //OPEN ROOT FILE

    gSystem->RedirectOutput("../logs/ComplexFitSamples5.log", "w");
    ...
    TH1F *h1 = new TH1F("h1", "Generated Distribution; Var; Counts", 700, 135.0, 240.0);
    t->Draw("var5 >>h1", "", "goff");
    h1->SetDirectory(0);
    f->Close();
    delete f;
    ...
    RooRealVar var("var5", "Variable", 135.0, 240.0);
    ...
    RooRealVar mean1("mean1", "Mean of Signal Component 1", 150.0, 145.0, 155.0);
    RooRealVar sigma1("sigma1", "Sigma of Signal Component 1", 2.0, 0.001, 10.0);

    RooRealVar mean2("mean2", "Mean of Signal Component 2", 165.0, 160.0, 170.0);
    RooRealVar sigma2("sigma2", "Sigma of Signal Component 2", 3.0, 0.001, 15.0);

    RooRealVar mean3("mean3", "Mean of Signal Component 3", 180.0, 175.0, 195.0);
    RooRealVar sigma3("sigma3", "Sigma of Signal Component 3", 4.0, 0.001, 20.0);

    RooRealVar frac1("frac1", "Fraction of Signal Component 1", 0.5, 0.0, 1.0);
    RooRealVar frac2("frac2", "Fraction of Signal Component 2", 0.5, 0.0, 1.0);
    ...
    RooRealVar mean4("mean4", "Mean of Background Component", 220.0, 195.0, 230.0);
    RooRealVar sigma4("sigma4", "Sigma of Background Component", 10.0, 1.0, 40.0);

    RooRealVar mean5("mean5", "Mean of Signal Component 5", 170.0, 160.0, 180.0);
    RooRealVar sigma5("sigma5", "Sigma of Signal Component 5", 10.0, 0.001, 40.0);

    RooRealVar fracbkg1("fracbkg1", "Fraction of Background Component 1", 0.5, 0.0, 1.0);
    RooRealVar fracbkg2("fracbkg2", "Fraction of Background Component 2", 0.5, 0.0, 1.0);
    ...
    RooBernstein background1("background1", "Background 1", var, RooArgList(a0, a1, a2));
    RooGaussian background2("background2", "Background 2", var, mean4, sigma4);
    RooGaussian background3("background3", "Background 3", var, mean5, sigma5);
    RooAddPdf background("background", "Total Background", RooArgList(background1, background2, background3), RooArgList(fracbkg1, fracbkg2));
    ...
    model.plotOn(frame2, Components(background3), LineColor(kCyan), LineStyle(kDashDotted), Name("bkg3"));
    ...
    signal3.plotOn(frame3, Name("sig3"), LineColor(kMagenta), LineStyle(kDashDotted), Normalization(hsig->Integral()*(1-frac1.getVal()-frac2.getVal()),RooAbsReal::NumEvent));
    ...
    cmain1->SaveAs("../Png_files/ComplexFitSamples5_results.png");
    cmain2->SaveAs("../Png_files/ComplexFitSamples5_pull.png");

    ofstream out("../Txt_files/ComplexFitSamples5_results.txt");
