...
void Newdata8(){
    ...
    TH1F *h1 = new TH1F("h1", "Generated Distribution; Var; Counts", 600, 50.0, 90.0);
    t->Draw("threshold_bkg >>h1", "", "goff");
    h1->SetDirectory(0);
    f->Close();
    delete f;
    ...
    RooRealVar var("threshold_bkg", "Variable", 50.0, 90.0);
    ...
    RooRealVar mean("mean", "Mean", 70.0, 65.0, 75.0);
    ...
    cmain->SaveAs("../Png_files/Newdata8.png");

    ofstream out("../Txt_files/Newdata8_results.txt");
