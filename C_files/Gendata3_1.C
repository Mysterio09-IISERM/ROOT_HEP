...
void Gendata3_1(){
    ...
    gSystem->RedirectOutput("../logs/Gendata3_1.log", "w");
    ...
    TH1F *h1 = new TH1F("h1", "Generated Distribution; Var; Counts", 700, 35.0, 65.0);
    t->Draw("var1 >>h1", "", "goff");
    h1->SetDirectory(0);
    f->Close();
    delete f;
    ...
    RooRealVar var("var1", "Variable", 35.0, 65.0);
    ...
    RooRealVar mean("mean", "Mean", 50.0, 45.0, 55.0);
    RooRealVar sigma("sigma", "Sigma", 4.0, 0.1, 10.0);
    ...
    TCanvas *cmain2 = new TCanvas("cmain2", "Pull Distribution and Pull Gauss", 1800, 600);
    cmain2->Divide(1,2);
    cmain2->cd(1);
    ...
    cmain1->SaveAs("../Png_files/Gendata3_1_results.png");
    cmain2->SaveAs("../Png_files/Gendata3_1_pull.png");

    ofstream out("../Txt_files/Gendata3_1_results.txt");
