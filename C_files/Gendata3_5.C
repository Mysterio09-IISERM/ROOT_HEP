...
void Gendata3_5(){
    ...
    gSystem->RedirectOutput("../logs/Gendata3_5.log", "w");
    ...
    TH1F *h1 = new TH1F("h1", "Generated Distribution; Var; Counts", 800, 160.0, 260.0);
    t->Draw("var5 >>h1", "", "goff");
    h1->SetDirectory(0);
    f->Close();
    delete f;
    ...
    RooRealVar var("var5", "Variable", 160.0, 260.0);
    ...
    RooRealVar mean1("mean1", "Mean1", 200.0, 190.0, 210.0);
    RooRealVar sigma1("sigma1", "Sigma1", 2.0, 0.1, 7.0);
    RooRealVar mean2("mean2", "Mean2", 240.0, 230.0, 250.0);
    RooRealVar sigma2("sigma2", "Sigma2", 3.0, 0.1, 7.0);
    RooRealVar frac("frac", "Fraction of Signal 1", 0.5, 0.0, 1.0);

    // BACKGROUND PARAMETERS

    RooRealVar tau("tau", "Tau", -0.1, -1.0, 0.0);
    RooRealVar mean_bkg("mean_bkg", "Mean of Background", 220.0, 200.0, 240.0);
    RooRealVar sigma_bkg("sigma_bkg", "Sigma of Background", 20.0, 1.0, 75.0);
    RooRealVar bkg_frac("bkg_frac", "Fraction of Background", 0.5, 0.0, 1.0);
    ...
    RooGaussian background2("background2", "Background PDF 2", var, mean_bkg, sigma_bkg);
    RooAddPdf background("background", "Combined Background PDF", RooArgList(background1, background2), bkg_frac);
    ...
    model.plotOn(frame2, Components(background1), LineColor(kBlue), LineStyle(kDashed), Name("bkg1"));
    model.plotOn(frame2, Components(background2), LineColor(kCyan), LineStyle(kDotted), Name("bkg2"));
    ...
    cmain1->SaveAs("../Png_files/Gendata3_5_results.png");
    cmain2->SaveAs("../Png_files/Gendata3_5_pull.png");

    ofstream out("../Txt_files/Gendata3_5_results.txt");
