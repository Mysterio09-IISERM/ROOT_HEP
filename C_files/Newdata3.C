...
void Newdata3(){
    ...
    TH1F *h1 = new TH1F("h1", "Generated Distribution; Var; Counts", 800, 90.0, 140.0);
    ...
    RooRealVar var("smeared_bw", "Variable", 90.0, 140.0);
    ...
    RooRealVar mean("mean", "Mean", 125.0, 120.0, 130.0);
    RooRealVar width("width", "Width", 2.5, 0.1, 10.0);
    RooRealVar sigma("sigma", "Sigma", 0.5, 0.1, 5.0);
    ...
    RooVoigtian signal("signal", "Signal PDF", var, mean, width, sigma);
    ...
    cmain->SaveAs("../Png_files/Newdata3.png");

    ofstream out("../Txt_files/Newdata3_results.txt");
