...
void Newdata9(){
    ...
    TH1F *h1 = new TH1F("h1", "Generated Distribution; Var; Counts", 800, 40.0, 100.0);
    t->Draw("double_peak >>h1", "", "goff");
    h1->SetDirectory(0);
    f->Close();
    delete f;
    ...
    RooRealVar var("double_peak", "Variable", 40.0, 100.0);
    ...
    RooRealVar mean1("mean1", "Mean1", 65.0, 60.0, 70.0);
    RooRealVar sigma1("sigma1", "Sigma1", 0.8, 0.1, 5.0);
    RooRealVar mean2("mean2", "Mean2", 70.0, 65.0, 75.0);
    RooRealVar sigma2("sigma2", "Sigma2", 1.5, 0.1, 7.0);
    RooRealVar frac("frac", "Fraction of Signal 1", 0.5, 0.0, 1.0);


    // BACKGROUND PARAMETERS

    RooRealVar tau("tau", "Tau", -0.08, -5.0, -0.001);
    ...
    cmain->SaveAs("../Png_files/Newdata9.png");

    ofstream out("../Txt_files/Newdata9_results.txt");
