...
void task1_2() {
    ...
    RooRealVar var("var", "Variable", 2.8, 3.4);
    RooArgSet vars(var);
    ...
    for (Long64_t i = 0; i < nentries; i++) {
        ...
        Double_t px = mu1_px + mu2_px;
        Double_t py = mu1_py + mu2_py;
        Double_t pz = mu1_pz + mu2_pz;
        Double_t E  = mu1_E  + mu2_E;
    ...
    ofstream out("../Txt_files/task1_2_results.txt");
