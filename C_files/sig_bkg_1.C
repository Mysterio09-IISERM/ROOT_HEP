...
void sig_bkg_1(){
    ...
    gSystem->RedirectOutput("../logs/sig_bkg_1.log", "w");

    TFile *f = new TFile("../Root_files/sig_bkg_1.root", "READ");
    ...
    RooRealVar var("var", "Variable", 0.0, 100.0);
    ...
    for (int i=1; i<=hsig->GetNbinsX(); i++){
        ...
        hsig->SetBinContent(i,sig_counts);
    }
    ...
    cmain1->SaveAs("../Png_files/sig_bkg_1_results.png");
    cmain2->SaveAs("../Png_files/sig_bkg_1_pull.png");

    ofstream out("../Txt_files/sig_bkg_1_results.txt");
