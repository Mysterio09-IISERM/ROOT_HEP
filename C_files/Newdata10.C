...
void Newdata10(){
    ...
    TH1F *h1 = new TH1F("h1", "Generated Distribution; Var; Counts", 800, 10.0, 90.0);
    t->Draw("weighted_data >>h1", "weight", "goff");
    h1->SetDirectory(0);
    f->Close();
    delete f;
    ...
    RooRealVar var("weighted_data", "Variable", 10.0, 90.0);
    ...
    RooRealVar mean("mean", "Mean", 50.0, 40.0, 60.0);
    RooRealVar sigma("sigma", "Sigma", 0.75, 0.1, 5.0);
    ...
    cmain->SaveAs("../Png_files/Newdata10.png");

    ofstream out("../Txt_files/Newdata10_results.txt");
